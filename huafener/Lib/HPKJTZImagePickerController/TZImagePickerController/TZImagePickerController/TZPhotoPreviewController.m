...
- (void)select:(UIButton *)selectButton {
    ...
    if (!selectButton.isSelected) {
        ...
        if (_tzImagePickerVc.selectedModels.count >= _tzImagePickerVc.maxImagesCount) {
            if (_tzImagePickerVc.allowPickingVideo == YES && _tzImagePickerVc.allowPickingImage == NO) {
                [_tzImagePickerVc showAlertWithTitle:[NSString stringWithFormat:@"你最多只能选择%zd个视频",_tzImagePickerVc.maxImagesCount]];
            } else {
